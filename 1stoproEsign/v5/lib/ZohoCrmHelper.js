...
var ZOHO = (function() {
    ...
    return {
        ...
        CRM: (function() {
            ...
            function searchRecord(Entity, Type, Query, page, per_page) {
                var data = {
            ...
            function remoteCall(method, requestData, type) {
                ...
                if (type != "CONNECTOR") {
                    ...
                    var oldfile = requestData.FILE;

                    var file = new File([oldfile], oldfile.name, { type: oldfile.type });
                ...
                API: {
                    ...
                    */
                    ...
                    searchRecord: function(data) {
                        ...
                        return searchRecord(Entity, Type, Query, page, per_page);
                    },
                    /**
                    ...
                    *        "email": "udhayakumar.d+milestone2@zohocorp.com"
                    *      },
                    ...
                    * @description To get details of particular approval waiting for your approval.
                    * @param {object} config - configuration object
